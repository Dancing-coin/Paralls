...
- 即使是 `Phase 0` demo，Godot 侧也必须遵守 [Godot源码底层基础设施与运行时约束.md](/d:/Projects/Paralls/docs/phase1/core/00-总纲/Godot源码底层基础设施与运行时约束.md)
- 不允许为了原型速度临时退回“后端逐骨骼高频遥控”或“客户端替代后端真值判断”的捷径
